...
# Fieldnote PRD to Plan

Break a PRD into a phased implementation plan using vertical slices (tracer bullets). Write the plan to `./plans/`, or to the directory named under `Docs → plans`
in `.fieldnote/profile.md` when that file exists.
